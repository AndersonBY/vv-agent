...
from v_agent.sdk.types import AgentDefinition
from v_agent.types import NoToolPolicy, SubAgentConfig
...
class AgentResourceLoader:
    ...
    def _load_hook_objects(self, hook_file: Path, *, diagnostics: list[str]) -> list[RuntimeHook]:
        module_name = f"v_agent_user_hook_{abs(hash(hook_file.resolve()))}"
