...
from v_agent.runtime.backends.base import CycleExecutor
from v_agent.runtime.context import ExecutionContext
from v_agent.runtime.state import Checkpoint, StateStore
...
class CeleryBackend:
    ...
    def __init__(
        ...
        *,
        ...
        cycle_task_name: str = "v_agent.celery_tasks.run_single_cycle",
    ) -> None:
...
def register_cycle_task(
    celery_app: Any,
    *,
    task_name: str = "v_agent.celery_tasks.run_single_cycle",
) -> Any:
    """Register the ``run_single_cycle`` task on *celery_app*.

    Returns the registered Celery task object.
    """
    from v_agent.runtime.backends.celery_tasks import run_single_cycle
