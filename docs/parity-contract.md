...
`contract.lock.json` selects contract `8.0.1` at revision
`24c5b365f03d211d552df998c1f30a0f7cbf4f0f`. Its immutable release artifact has
SHA-256 `8bbf4eca2a57c1c5e99c7f11f3dda8c7000a4af7125e633458106c2fa0c08a53`.
...
python3 scripts/contract_snapshot.py sync \
  ...
  --artifact /path/to/vv-agent-contract-8.0.1.zip \
  --artifact-url https://github.com/AndersonBY/vv-agent-contract/releases/download/v8.0.1/vv-agent-contract-8.0.1.zip
```
