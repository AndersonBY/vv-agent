...
| `checkpoint-resume.md` | Checkpoint v10, immutable run definitions, model-call ledgers, deferred barriers, ambiguity, host interaction, and durable terminal ordering. |
